...
import VC.ASTs.Type;
 ...
 public class Frame {
  ...
  public int getCurStackSize() {
   ...
   public HashMap<String, Integer> getVarPosMap(){
	   return localvariables;
   }
   HashMap<String,Type> localVariableTypes = new HashMap<String,Type>();
   public HashMap<String, Type> getVarTypeMap(){
